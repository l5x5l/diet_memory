...
data class SigninUserData(var email : String = GlobalApplication.STRING_DEFAULT, var password : String = GlobalApplication.STRING_DEFAULT,
                          var name : String = GlobalApplication.STRING_DEFAULT, var phoneNu : String = GlobalApplication.STRING_DEFAULT,
                          var height : Int = -1, var weight : Int = -1, var exercise : Int = -1)
